...
import { ChevronRight, ShoppingBag, Shield, Truck, Package } from 'lucide-react';
    ...
    <MainLayout>
      <div className="animate-fade-in max-w-7xl mx-auto px-6 py-12 md:py-20">
        <nav className="flex items-center space-x-3 text-[10px] uppercase tracking-[0.25em] text-gray-400 mb-12">
          <Link href="/" className="hover:text-black text-nowrap">Início</Link>
          <ChevronRight size={10} />
          <Link href="/catalog" className="hover:text-black text-nowrap">Catálogo</Link>
          <ChevronRight size={10} />
